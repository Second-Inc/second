  ...
  return (
    ...
    >
      ...
      <CommandPrimitive.Input
        ...
        className={cn(
          "h-full w-full bg-transparent text-xs outline-hidden placeholder:text-muted-foreground disabled:cursor-not-allowed disabled:opacity-50",
          className
        )}
        {...props}
      />
...
function CommandEmpty({
  ...
  return (
    <CommandPrimitive.Empty
      ...
      className={cn("py-6 text-center text-xs/relaxed text-muted-foreground", className)}
      {...props}
    />
  )
}
