...
5. Draft app-agent runtime can start from the draft file, but live custom
   tools and app-data tools are usable only while the current `agents.json`
