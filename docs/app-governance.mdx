...
configuration until the platform records an approval for the exact canonical
JSON hash.
...
the source persistence path compares the canonical hash and marks the approval
stale if it changed.
