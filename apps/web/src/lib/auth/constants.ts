...
export const LOADER_ONBOARDING_PATH = "/onboarding/loader";
export const PROVIDER_ONBOARDING_PATH = "/onboarding/provider";
export const START_ONBOARDING_PATH = "/onboarding/start";
